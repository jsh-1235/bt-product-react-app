...
export default function CreateModal(props) {
  ...
  return (
    <div>
      ...
      <Modal title="Create" closable={true} footer={null} visible={visible} confirmLoading={confirmLoading} onCancel={handleCancel}>
        <Formik
          initialValues={{
            title: "",
            description: "",
          ...
          onSubmit={(values, actions) => {
            ...
            setTimeout(() => {
              ...
              dispatch(createProduct(dataToSubmit)).then((response) => {
